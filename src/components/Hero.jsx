export default function Hero() {
  return (
    <section id="hero" className="flex-row-reverse lg:mx-16 lg:flex">
      ...
      <div className="flex flex-col items-center gap-4 pt-4 text-center lg:items-start lg:text-left">
        <h1 className="text-4xl font-bold text-[#232127] lg:text-5xl">
          More than just shorter links
        </h1>
        <p className="px-10 text-[#BFBFBF] lg:px-0">
          Build your brand&apos;s recognition and get detailed insights on how
          your links are performing
        </p>
        <a
          href="#"
          className="w-36 rounded-full  bg-[#2ACFCF] p-2 text-white lg:text-center"
        >
          Get Started
        </a>
      </div>
